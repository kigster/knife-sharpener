...
describe 'provision cli' do
  ...
  describe 'host number is provided' do
    let(:expected_command) {'knife ec2 server create --image 9ec5c0c-a941-11e2-a7dc-57a6b041988f --flavor g3-highmemory-17.125-smartos --subnet smartos-base64 --security_group_id 42325ea0-eb62-44c1-8eb6-0af3e2f83abc,c8cde927-6277-49ca-82a3-741e8b23b02f --environment test --node-name memcached-sessions545.test --run-list role[ec2] 2>&1 > ./tmp/memcached-sessions545.test_provision.log &'}
    ...
    let(:expected_command_ssh) {'knife ec2 server create --image 9ec5c0c-a941-11e2-a7dc-57a6b041988f --flavor g3-highmemory-17.125-smartos --subnet smartos-base64 --security_group_id 42325ea0-eb62-44c1-8eb6-0af3e2f83abc,c8cde927-6277-49ca-82a3-741e8b23b02f --environment test --node-name memcached-sessions-ssh545.test --run-list role[ec2] --ssh-user ops 2>&1 > ./tmp/memcached-sessions-ssh545.test_provision.log &'}
