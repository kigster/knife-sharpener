...
describe Knife::Sharpener::Command::Bootstrap do
  describe '#shell_commands' do
    ...
    before do
      allow_any_instance_of(Knife::Sharpener::Command::Bootstrap::HostCommand).to receive(:ip_for_host) { '1.2.3.4' }
    end

    context 'host is specified' do

      let(:subject) { Knife::Sharpener::Command::Bootstrap.new(template_configuration, number: '1') }
    ...
    context 'ssh user is overridden' do
      let(:subject) { Knife::Sharpener::Command::Bootstrap.new(template_configuration, number: '1', ssh_user: 'root') }
    ...
    context 'reset is true' do
      let(:subject) { Knife::Sharpener::Command::Bootstrap.new(template_configuration, number: '1', ssh_user: 'root', reset: true) }
    ...
    context 'sudo is true' do
      let(:subject) { Knife::Sharpener::Command::Bootstrap.new(template_configuration, number: '1', ssh_user: 'root', sudo: true) }
